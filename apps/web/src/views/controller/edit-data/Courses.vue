    ...
    <div>
        ...
        >
            ...
            <div class="card courses">
                ...
                <div v-for="(course, index) in courses" :key="index" class="course-entry flex gap-4">
                    <FloatLabel variant="on">
                        <InputText
            ...
            <div class="card mentoring">
                ...
                <div v-for="(mentor, index) in mentoring" :key="index" class="course-entry flex flex-wrap gap-4">
                    <FloatLabel variant="on">
                        <Select
                            v-model="mentor.type"
            ...
            <div class="card discounts">
                ...
                <div v-for="(reduction, index) in reductions" :key="index" class="course-entry flex gap-4">
                    <FloatLabel variant="on">
                        <Select
