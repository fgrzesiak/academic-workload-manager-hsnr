...
async function main() {
  ...
  if (supervisionTypeCount === 0) {
    ...
    const supervisionTypes = [
      {
        typeOfSupervision: "Bachelorarbeit",
        calculationFactor: 0.2,
        semesterPeriod: { connect: { id: 1 } },
      },
      {
        typeOfSupervision: "Masterarbeit",
        calculationFactor: 0.2,
        semesterPeriod: { connect: { id: 1 } },
      },
      {
        typeOfSupervision: "Zweitprüfer",
        calculationFactor: 0.2,
        semesterPeriod: { connect: { id: 1 } },
      },
      {
        typeOfSupervision: "Praxissemster",
        calculationFactor: 0.2,
        semesterPeriod: { connect: { id: 1 } },
      },
      {
        typeOfSupervision: "Bachelorarbeit (ab SS24)",
        calculationFactor: 0.3,
        semesterPeriod: { connect: { id: 8 } },
      },
      {
        typeOfSupervision: "Masterarbeit (ab SS24)",
        calculationFactor: 0.3,
        semesterPeriod: { connect: { id: 8 } },
      },
      {
        typeOfSupervision: "Zweitprüfer (ab SS24)",
        calculationFactor: 0.1,
        semesterPeriod: { connect: { id: 8 } },
      },
    ];
